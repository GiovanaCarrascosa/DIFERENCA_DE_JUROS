...
def calcular_diferenca_juros(capital_inicial: float, taxa_anual: float, tempo_anos: float) -> float:
    ...
    montante_composto = calcular_juros_compostos (capital_inicial, taxa_anual, tempo_anos)[1]

    diferenca_juros = montante_composto - montante_simples
    
    return round(diferenca_juros,2)
